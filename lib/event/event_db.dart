...
class EventDB {
  ...
  static Future<List<Job>> getJob() async {
    ...
    try {
      var response = await http.get(
          Uri.parse('http://192.168.100.131:3000/jobs/list_job'),
  ...
  static Future<String> addUser(String name, String nohp, String pass,
    ...
    try {
      var response = await http.post(
          Uri.parse('http://192.168.100.131:3000/users/add_userbyadm'),
          headers: <String, String>{
            // 'Content-Type': 'application/json; charset=UTF-8',
            'Authorization': 'Bearer ${profile.token}'
          },
  ...
  static Future<void> updateUserbyadm(String idUser, String name, String nohp,
    ...
    try {
      var response = await http.patch(
          Uri.parse(
              'http://192.168.100.131:3000/users/update_userbyadm/$idUser'),
          headers: <String, String>{
            // 'Content-Type': 'application/json; charset=UTF-8',
            'Authorization': 'Bearer ${profile.token}'
          },
  ...
  static Future<void> updateUserbyop(String idUser, String name, String nohp,
    ...
    try {
      var response = await http.patch(
          Uri.parse('http://192.168.100.131:3000/users/update_userbyop'),
          headers: <String, String>{
            // 'Content-Type': 'application/json; charset=UTF-8',
            'Authorization': 'Bearer ${profile.token}'
          },
  ...
  static Future<void> deleteUser(String id) async {
    ...
    try {
      var response = await http.delete(
          Uri.parse('http://192.168.100.131:3000/users/delete_userbyadm/$id'),
          headers: <String, String>{
            // 'Content-Type': 'application/json; charset=UTF-8',
            'Authorization': 'Bearer ${profile.token}'
          });
  ...
  static Future<List<Task>> getTask(String idUser) async {
    ...
    try {
      var response = await http.get(
          Uri.parse('http://192.168.100.131:3000/tasks/list_task'),
          headers: <String, String>{
            'Content-Type': 'application/json; charset=UTF-8',
            'Authorization': 'Bearer ${profile.token}'
          });
  ...
  static Future<String> addTask(
      String taskName, String description, String idUser) async {
    String reason;
    try {
  ...
  static Future<void> updateProgress(String progress, String idTask) async {
    try {
